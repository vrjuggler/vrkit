 ...
 */
boost::function<bool ()> eval(const iter_t& i, vrkit::WandInterfacePtr wandIf)
{
   boost::function<bool ()> f;
                               ...
                               WandInterfacePtr wandIf)
{
   ...
   {
      VRKIT_STATUS << "WARNING: Use of the comma-separated button "
                   << "configuration is deprecated." << std::endl;
      ...
      VRKIT_STATUS << "         Consider using " << buttonString
                   << " instead." << std::endl;
   }
   ...
   {
      VRKIT_STATUS << "WARNING: Use of '-1' for the button configuration is "
                   << "deprecated.\n"
